...
public class ExamenVisual {
	...
	public void setUltimoControlVisual(String ultimoControlVisual) {
	...
	public void setCylOi(String cylOi) {
		this.cylOi = cylOi;
	}
	...
	public String getAddValor() {
		return addValor;
	}
	public void setAddValor(String addValor) {
	...
	public String getBiomicroscopia() {
		return biomicroscopia;
	}
	public void setBiomicroscopia(String biomicroscopia) {
