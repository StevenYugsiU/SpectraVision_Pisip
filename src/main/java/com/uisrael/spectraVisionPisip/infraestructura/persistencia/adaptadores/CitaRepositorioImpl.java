...
public class CitaRepositorioImpl implements ICitaRepositorio{
	...
	@Override
	public List<Cita> buscarPorFechaYHora(LocalDate fecha, LocalTime hora) {
	...
	@Override
	public List<Cita> buscarPendientesOrdenadasPorFecha() {
		return jpaRepositorio.findByEstadoOrderByFechaAscHoraAsc("Pendiente")
				.stream()
				.map(entityMapper :: toDomain)
				.toList();
	}
