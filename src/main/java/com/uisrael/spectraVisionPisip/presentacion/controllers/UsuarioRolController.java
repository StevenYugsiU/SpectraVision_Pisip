...
public class UsuarioRolController {
	...
	public UsuarioRolResponseDto actualizar(
			@PathVariable int idUsuarioRol,
			@Valid @RequestBody UsuarioRolRequestDto requestUsuarioRol) {

		return mapper.toResponseDto(
				usuarioRolUseCase.actualizar(
						idUsuarioRol,
						mapper.toDomain(requestUsuarioRol)));
	}
